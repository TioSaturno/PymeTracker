  ...
  return (
    <aside className="w-64 h-screen bg-white/80 backdrop-blur-xl border-r border-[#e4e2e2] p-5 flex flex-col">
      <div className="p-4 mb-6">
        ...
        <div className="text-xs mt-1 uppercase tracking-wider font-semibold text-[#725950]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="space-y-2 pt-4 border-t border-[#e4e2e2]">
        <Link
          href="/"
          className="flex items-center gap-x-3 rounded-xl px-3 py-2.5 text-[#4f4441] hover:bg-[#f5f3f3] transition-all duration-200"
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          <LayoutGrid className="h-5 w-5 text-[#817470]" />
